...
st.title("Assistente Pro Git")
st.caption("Faça perguntas sobre o livro oficial do Git. Respondidas com IA, RAG e roteamento inteligente.")
...
st.divider()
st.caption("Desenvolvido para o Projeto Portfólio de IA Generativa. Utiliza RAG, Cache Semântico e Model Routing.")